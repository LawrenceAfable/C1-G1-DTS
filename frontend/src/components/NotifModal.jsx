...
export default function NotifModal() {
  return (
    <main className="notif-modal-page">
      <section className="notif-modal-header">
      ...
      <section className="notif-modal-body">
        <div className="nm-item">
          <img className="nm-image" src="https://api.dicebear.com/7.x/lorelei/svg?seed=Sasuke" alt="Anime Avatar" />
          <div className="nm-notif-info">
        ...
        <div className="nm-item">
          <img className="nm-image" src="https://i.pinimg.com/736x/c6/5a/bc/c65abc09dde1a7dbb78df5845744a932.jpg" alt="Anime Avatar 2" />
          <div className="nm-notif-info">
            <span>Anna</span>
            <span>
        ...
        <div className="nm-item">
          <img className="nm-image" src="https://i.mydramalist.com/jQjnXO_5c.jpg" alt="User" />
          <div className="nm-notif-info">
        ...
        <div className="nm-item">
          <img className="nm-image" src="https://i.pinimg.com/736x/64/00/dd/6400dd0e35e6f3919fe01c0254aea9a0.jpg" alt="User" />
          <div className="nm-notif-info">
            <span>Samantha</span>
            <span>
        ...
        <div className="nm-item">
          <img className="nm-image" src="https://randomuser.me/api/portraits/men/21.jpg" alt="User" />
          <div className="nm-notif-info">
        ...
        <div className="nm-item">
          <img className="nm-image" src="https://randomuser.me/api/portraits/women/30.jpg" alt="User" />
          <div className="nm-notif-info">
